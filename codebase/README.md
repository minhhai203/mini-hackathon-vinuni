...
This folder contains the full runnable prototype codebase. From the repository root, enter this folder before running backend, frontend, tests, crawler, or Docker commands:
